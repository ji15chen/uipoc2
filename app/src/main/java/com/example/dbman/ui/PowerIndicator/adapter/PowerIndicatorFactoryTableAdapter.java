...
public class PowerIndicatorFactoryTableAdapter extends SampleTableAdapter {
    private  int width;
    private  int height;
    List<EquipTypeBriefModel> model = null;
    private static final String [] headers = new String[]{"序号", "装备型号", "计量单位", "管理类别", "使用年限", "退保比例", "保修期"};
    View.OnClickListener onClickListener;

    public PowerIndicatorFactoryTableAdapter(Context context, View.OnClickListener onClickListener) {
        super(context);
