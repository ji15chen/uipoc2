...
public abstract class AbstractUIStateBindingActivityWithSlideMenu extends AbstractUIStateBindingActivity implements SlidingActivityBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setBehindContentView(getMenuId());
